 ...
 * CommentReports
 *
 * @ORM\Table(name="comment_reports", indexes={@ORM\Index(name="fk_comment_reports_reporter", columns={"reporter_id"}), @ORM\Index(name="ix_comment_reports_status_created", columns={"status", "created_at"}), @ORM\Index(name="ix_comment_reports_comment", columns={"comment_id"})})
 * @ORM\Entity
 */
